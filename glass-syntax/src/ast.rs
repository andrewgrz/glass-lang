...
impl From<usize> for ExprId {
    fn from(n: usize) -> Self { ExprId(n) }
}

impl From<ExprId> for usize {
    fn from(id: ExprId) -> Self { id.0 }
}
...
mod tests {
    ...
    fn test_expr_arena() {
        ...
        // The bin op21
        let bin_op = ExprAst::BinOp { lhs: a, op: BinOp::Add, rhs: b };
        ...
        assert_eq!(&ExprAst::new_int(1), arena.get_node(a).expect("couldn't get a"));
        assert_eq!(&ExprAst::new_int(2), arena.get_node(b).expect("couldn't get b"));
